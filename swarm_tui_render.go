...
func (m tuiModel) viewHelpScreen() string {
	...
	sb.WriteString(key("P", "Edit role prompt for selected agent's role (in-TUI editor)") + "\n")
	...
	sb.WriteString(key("I", "Icinga monitor — services + recent alerts  (s=spawn agent on alert)") + "\n")
